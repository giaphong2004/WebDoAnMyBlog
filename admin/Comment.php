                    ...
                    <tbody>
                        <?php foreach ($comments as $comment) { ?>
                            <tr>
                                ...
                                <td> <a href="single_post.php?post_id=<?= $comment['post_id'] ?>">
                                        <?php $p = getById($conn, $comment['post_id']);
                                        echo $p['post_title']; ?></a></td>

                                <td><?= $comment['comment'] ?></td>
                                <td>
                                    <?php $u = getUserById($conn, $comment['user_id']);
                                    echo '@' . $u['username']; ?>
                                </td>
                                <td><a href="comment-delete.php?comment_id=<?= $comment['comment_id'] ?>"
